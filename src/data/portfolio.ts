export const profile = {
  ...
  summary: [
    "Engenheiro de Software Full Stack com foco no desenvolvimento de aplicações web escaláveis, aplicações desktop com Electron e APIs backend utilizando TypeScript e C#.",
    "Atuação especializada em arquitetura moderna de frontend com React e Next.js, construção de sistemas baseados em microserviços e otimização de desempenho de aplicações.",
    "Fundador da DomusDev, onde desenvolvo produtos digitais e plataformas de software voltadas à criação de soluções tecnológicas modernas e escaláveis.",
  ],
} as const
